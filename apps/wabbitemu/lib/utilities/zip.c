...
typedef struct
{
	...
	voidpf filestream;        /* IO structure of the zip file */
...
/************************************************************/
extern zipFile ZEXPORT zipOpen2 (const TCHAR *pathname, int append, zipcharpc *globalcomment,
...
extern int ZEXPORT zipOpenNewFileInZip2(zipFile file, const TCHAR *filename, const zip_fileinfo *zipfi,
										const void *extrafield_local, uInt size_extrafield_local,
										const void *extrafield_global, uInt size_extrafield_global,
										const char *comment, int method, int level, int raw)
{
...
extern int ZEXPORT zipOpenNewFileInZip3 (zipFile file, const TCHAR *filename, const zip_fileinfo *zipfi,
										 const void *extrafield_local, uInt size_extrafield_local,
										 const void *extrafield_global, uInt size_extrafield_global,
										 const char *comment, int method, int level, int raw,
										 int windowBits, int memLevel, int strategy,
...
extern int ZEXPORT zipOpenNewFileInZip (zipFile file, const TCHAR *filename, const zip_fileinfo *zipfi,
										const void *extrafield_local, uInt size_extrafield_local,
										const void *extrafield_global, uInt size_extrafield_global,
